...
linear seperablity of the feature space and the number of support vectors.
...
BoxConstraint parameter manually. I observed that setting it to 15 resulted in 2 suuport vectors for two cases.
...
Using four features, having higher dimensions, have resulted in SVM Model linearly seperating the feature space. Hence
