...
\begin{center}
    \begin{figure}[h]
        \begin{tabular}{ccc}
        \hspace*{-2.3cm}\subfloat[ROC1]{\includegraphics[width = 2.5in]{1.png}} &
        \subfloat[ROC2]{\includegraphics[width = 2.5in]{2.png}} &
        \subfloat[ROC3]{\includegraphics[width = 2.5in]{3.png}} \\
        \end{tabular}
